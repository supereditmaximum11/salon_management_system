...
?>
							<h1><font color="#606060"><center>APPOINTMENT REQUESTS</h1></font><br>
							<?php
										...
										?>
												<tr>
													...
													?>
															...
															<td><center><a href="reject_app_request.php?uid=<?php echo $row['App_id'];?>" onclick="return confirm('Are you sure??')"><img src="images/_reject_button.png" width="30px"></a></td>	
															<?php
														}
															?>
